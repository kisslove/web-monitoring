...
(function (a) {
  ...
  a.theme = {
    ...
    colorAxis: { maxColor: "#60042E", minColor: "#FDD089" },
    plotOptions: { map: { nullColor: "#fefefc" } },
    navigator: { series: { color: "#FF7F79", lineColor: "#A0446E" } },
  };
...
export class CustomHighchartComponent implements OnInit {
  ...
  ngOnChanges(changes) {
    if (
      changes.highConfig.currentValue &&
      changes.highConfig.currentValue != changes.highConfig.previousValue
    ) {
      ...
      _.extend(
        {},
        {
          ...
          tooltip: {
            ...
            pointFormat:
              "数量: <b>{point.y}</b><br/>占比: <b>{point.percentage:.1f}%</b>",
          },
          plotOptions: {
            pie: {
      ...
      _.extend(
        {},
        {
          ...
          tooltip: {
            useHTML: true,
            headerFormat:
              '<span style="font-size: 10 px;font - weight: bold">{point.key}</span><table>',
